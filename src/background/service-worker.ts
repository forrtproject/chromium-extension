...
// failing must not be retried on each of them. The attempt time is held in
// memory for the life of this worker and stored as well, because the worker
// idles out between checks and would otherwise forget it.
